{% raw %}
const RELEASE_ID = '20260810t041909097z-f2c9cb79bca5'
const RELEASE_CREATED_AT = 1786335549097
...
const TOOLBOX_ROUTES = new Set(["/","/settings","/calculator","/gst-calculator","/financial-calculators","/health-calculators","/unit-converter","/currency-converter","/hsn-sac-lookup","/pin-code-search","/ifsc-code-search","/world-clock","/timer","/stopwatch","/countdown-timer","/weather","/dictionary","/script-conversion","/audio-recorder","/audio-editor"])
