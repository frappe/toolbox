{% raw %}
const RELEASE_ID = '20260810t043633391z-ecd6bc35ff78'
const RELEASE_CREATED_AT = 1786336593391
...
const TOOLBOX_ROUTES = new Set(["/","/settings","/calculator","/gst-calculator","/financial-calculators","/bmi-calculator","/bmr-calculator","/tdee-calculator","/pace-calculator","/unit-converter","/currency-converter","/hsn-sac-lookup","/pin-code-search","/ifsc-code-search","/world-clock","/timer","/stopwatch","/countdown-timer","/weather","/dictionary","/script-conversion","/audio-recorder","/audio-editor"])
