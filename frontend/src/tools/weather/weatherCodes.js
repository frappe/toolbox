...
const WEATHER_CODES = {
  ...
  68: { label: 'Slight sleet', icon: 'lucide-cloud-hail' },
  69: { label: 'Heavy sleet', icon: 'lucide-cloud-hail' },
  ...
  83: { label: 'Slight sleet showers', icon: 'lucide-cloud-hail' },
  84: { label: 'Heavy sleet showers', icon: 'lucide-cloud-hail' },
